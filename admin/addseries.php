<?php
    ...
    if(isset($_POST['save']))
    {
     ...
     $qry="INSERT INTO `shows`(`title`, `trailer`, `showd`, `duration`, `longd`, `shortd`, `did`, `actors`, `genre`,`genret`, 
     `lang`, `pub`, `rating`, `kids`, `thumb`, `banner`) VALUES ('$title','$trailer','$movie','$duration','$long','$short','$did',
     '$actor','$genre','$genre2','$lang','$pub','$rate','$kids','$img1','$img2')";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <button type="submit" class="btn btn-primary waves-effect waves-light" name="save" onclick="window.location.href='viewshows.php';">View Shows</button>
                               <!-- <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">TV Shows</a></li>
                                    
                                    <li class="breadcrumb-item active">Add Shows</li>
                                </ol> -->
                            </div>
                            <h4 class="page-title">Add Series</h4>
                        </div>
                    </div>
                </div>     
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Show URL</label>
                                    ...
                                    <button type="submit"
                                        ...
                                        <button type="submit" class="btn btn-secondary waves-effect waves-light" name="save" onclick="window.location.href='viewshows.php';">Back</button>
                                </form>
