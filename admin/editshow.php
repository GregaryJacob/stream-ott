<?php
    ...
    if(isset($_POST['save']))
    {
     ...
     $qry="update `shows` set `title`='$title', `trailer`='$trailer', `showd`='$movie', `duration`='$duration', `longd`='$long', 
     `shortd`='$short', `did`='$did', `actors`='$actor', `genre`='$genre', `lang`='$lang', `pub`='$pub', `rating`='$rate', 
      `kids`='$kids', `thumb`='$img1', `banner`='$img2' where sid='$sid' ";
        mysqli_query($conn,$qry);
        echo "<script>alert('Show Updated.');window.location='viewshows.php';</script>";
    }
?>
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">View Shows</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                    $all="select shows.*,director.dnm from shows inner join director on shows.did=director.did where
                                    shows.sid='$sid'";
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="txtmovie" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" value="<?php echo $allrw['showd'] ?>" required="">
                                        <small id="emailHelp" class="form-text text-muted"></small>
                                    </div>                                                                                                           
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-label select-label" name="cmbrate" id="example-select">
                                            <option selected><?php echo $allrw['rating'] ?></option> 
