...
if(isset($_POST['login']))
{
    $email=$_POST['email'];
    $pass=$_POST['pass'];
    $sql = "SELECT *  FROM `tbl_user` WHERE `email` LIKE '$email' AND `pass` LIKE '$pass' AND `isdel` = 1;";
    $log=dbset($sql,2);
    if($log!=0) 
    {
        $user=dbset($sql,3);
            ...
            <div class="col-lg-5 col-md-12 align-self-center">
               <div class="sign-user_card ">                    
                     ...
                     <div class="sign-in-from w-100 m-auto">
                        ...
                        <form class="mt-4" action="?" method="post">
                           ...
                           <div class="form-group">                                 
                              ...
                              <div class="sign-info">
                                 <button type="submit" name="login" class="btn btn-hover">Sign in</button>
                  ...
                  <div class="mt-3">
                     ...
                     <div class="d-flex justify-content-center links">
                        <a href="reset.php" class="f-link">Forgot your password?</a>
                     </div>
                  </div>
               </div>
            </div>
