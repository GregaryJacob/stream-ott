...
if(isset($_POST['login']))
{
    $email=$_POST['usr'];
    $pass=$_POST['pass'];
    $sql = "SELECT *  FROM `tbl_user` WHERE `uid` = $uid AND `pass` LIKE '$pass';";
    $log=dbset($sql,2);
    if($log!=0) 
    {
       //s $msg="Password changed successfully";
        header("Location:index.php?kid=0");
               ...
               <div class="sign-user_card ">                    
                  <div class="sign-in-page-data">
                     <div class="sign-in-from w-100 m-auto">
                        <h3 class="mb-3 text-center">Enter password for kids mode off</h3>
                        ...
                        <form class="mt-4" action="?u=<?php echo $uid?>" method="post">
                          <input type="hidden" name="usr" value="<?php echo $uid ?>"/>
                           <div class="form-group">                                 
                              ...
                              <div class="sign-info">
                                 <button type="submit" name="login" class="btn btn-hover">off</button>
                                 <a href="index.php" name="exit" class="btn btn-hover">Cancel</a>                  
                              </div>                                    
