 ...
 <section class="iq-main-slider site-video">
      <div class="container-fluid" style="padding:0">
         <div class="row">
            <div class="col-lg-12">
               <div class="pt-0">
               <iframe width="100%" height="600px" src="<?php echo getEmbedUrl($row['showd']) ?>?&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
