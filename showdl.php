...
$sql = "SELECT *  FROM `shows` WHERE `sid` LIKE '$g';";
$row=dbset($sql,4);
            ...
            <div class="col-lg-12">
                  ...
                  <div class="row">
                    ...
                    <div class="iq-blog-image">
                     ...
                     <div class="d-flex align-items-center r-mb-23" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="150" data-iq-duration="1" data-iq-delay=".6">
                              <a href="movieview.php?g=<?php echo $g ?>" class="btn btn-hover iq-button"><i class="fa fa-play mr-2"
               ...
               <div class="streamit-content-details trending-info g-border iq-rtl-direction">
                  <ul class="trending-pills-header d-flex nav nav-pills align-items-center text-center  mb-5 justify-content-center" role="tablist">
                     <li class="nav-item">
                        <a class="nav-link active show" data-toggle="pill" href="#dectripton-1" role="tab" aria-selected="true">Director</a>
                     </li>
                  
                     <li class="nav-item">
                        <a class="nav-link" data-toggle="pill" href="#sourse-1" role="tab" aria-selected="false">Description</a>
                     </li>
                  </ul>
