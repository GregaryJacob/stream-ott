...
if($kid==1)
{
   $sql = "SELECT *  FROM `shows` WHERE  `kids` LIKE 'On';";
}
else
{
...
?>
            ...
            <div class="swiper-slide  slide swiper-bg s-bg-1 " style="background: url(sbanner/<?php echo  $row['banner'] ?>)">
                        ...
                        <div class="col-lg-7 col-md-12">
                           ...
                           <div class="trending-list" data-wp_object-in="fadeInUp" data-delay-in="1.2">
                              <div class="text-primary title starring">
                                 Starring: <span class="text-body"><a href="cast-karen-gilchrist.html"><?php echo $row['actors'] ?></a>
                           ...
                           <div class="d-flex align-items-center r-mb-23" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="150" data-iq-duration="1" data-iq-delay=".6">
                              <a href="showview.php?g=<?php echo $row['sid'] ?>" class="btn btn-hover iq-button"><i class="fa fa-play mr-2"
